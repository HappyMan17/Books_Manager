...
const Sidebar = () => {
  ...
  return (
    <section className="h-screen">
      {/* <!-- Dark open --> */}
      <div className="w-16 md:w-40 flex-col items-center h-full overflow-hidden text-gray-400 bg-gray-900">
        <a className="flex items-center w-full px-3 mt-3" href="#">
          <svg className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            <path d="M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" />
          </svg>
          <span className="sm:hidden md:flex ml-2 text-sm font-bold">The App</span>
        </a>
        <div className="w-full px-2">
          <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
            {
              pages.map(page => (
                <Link
                  key={page.name}
                  className={`flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300 ${pageSelected === page.name ? 'bg-gray-700 text-gray-300' : ''}`}
                  href={`/home/${page.route}`}
                  onClick={() => setpageSelected(page.name)}
                >
                  {page.icon}
                  <span className="hidden md:flex ml-2 text-sm font-medium">{page.name}</span>
                </Link>
              ))
            }
          </div>
          <div className="flex flex-col items-center w-full mt-2 border-t border-gray-700">
            <Link className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
              ...
              <span className="hidden md:flex ml-2 text-sm font-medium">Products</span>
            </Link>
            <Link className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
              <SettingsIcon />
              <span className="hidden md:flex ml-2 text-sm font-medium">Settings</span>
            </Link>
            <Link className="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
              <MessageIcon />
              <span className="hidden md:flex ml-2 text-sm font-medium">Messages</span>
        ...
        <Link className="flex items-center justify-center w-full h-16 mt-auto bg-gray-800 hover:bg-gray-700 hover:text-gray-300" href="#">
          <AccountIcon />
          <span className="hidden md:flex ml-2 text-sm font-medium">Account</span>
        </Link>
      </div>
      {/* <!-- Component End  --> */}
      
      {/* <!-- light open --> */}
      {/* <div className="hidden flex-col items-center w-16 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
      ...
      {/* <!-- Light close --> */}
      {/* <div className="hidden flex-col items-center w-40 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
        <a className="flex items-center w-full px-3 mt-3" href="#">
          <svg className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            <path d="M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" />
          </svg>
